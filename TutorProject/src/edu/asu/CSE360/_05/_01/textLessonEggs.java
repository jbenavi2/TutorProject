		...
		doneButton.addActionListener(new ActionListener() {
 			public void actionPerformed(ActionEvent e) {
 				if (doneButton.isEnabled()) {
 					removeAll();
					setLayout(new BorderLayout());
					lessonChoicesEggs lce = new lessonChoicesEggs();
					add(lce, BorderLayout.CENTER);
					revalidate();
					repaint();
 				}
 			}
 			...
 			public void actionPerformed(ActionEvent e) {
 				if (yolkButton.isEnabled()) {
 					textArea.setText("The Role of Egg Yolks: Fat\r\n" + 
 							...
 							"\r\n" + 
 							"Common recipes that often use just the egg yolks: Custards, pastry cream, cakes, ice cream, creme brule, and curds.");
 				}
 			}
		});
		//whites
 			...
 			public void actionPerformed(ActionEvent e) {
 				if (doneButton.isEnabled()) {
 					textArea.setText("The Role of Egg Whites: Foam!\r\n" + 
 							"When egg whites are used alone, they perform an entirely different role from the yolks, especially when whipped. Whipping and using egg whites in a recipe does not have to be as intimidating as you may think, and we'll be talking much more about this in a few days. For now, just know that whipping egg whites means incorporating millions of little air bubbles within the white. This creates a fairly stable foam that we can use to make everything from a soufflﾃｩ to meringue. To help stabilize egg whites even further, we can add acidic elements, like cream of tartar and lemon juice.\r\n" + 
 							"\r\n" + 
 							"One of the best ways to use whipped egg whites is as a natural leavening agent in something like a delicate cake or a soufflﾃｩ. In the heat of the oven, the air trapped in the foam starts to expand, causing the recipe rise without the need for things like yeast or baking soda. In fact, whipped egg whites are how many classic baked goods, like sponge cakes, got their lift in the days before baking soda and baking powder!\r\n" + 
 							"\r\n" + 
 			...
 			public void actionPerformed(ActionEvent e) {
 				if (doneButton.isEnabled()) {
 					textArea.setText("The Role of Whole Eggs: Fat and Foam\r\n" + 
 							...
 							"\r\n" + 
 							"Yolks and whites can also be used separately in the same recipe. This truly is the best of both worlds, with the yolks providing richness to a base or batter while the whipped whites do their job of lightening and leavening. Chiffon cakes and soufflﾃｩs are good examples of this kind of recipe.\r\n" + 
 							"\r\n" + 
 			...
 			public void actionPerformed(ActionEvent e) {
 				if (doneButton.isEnabled()) {
 					textArea.setText("Master the Basics of Egg Science & Safety\r\n" + 
 							...
 							"\r\n" + 
 							"Egg Safety\r\n" + 
 							"Trace amounts of salmonella the bacteria responsible for many incidents of food poisoning can sometimes be found in raw eggs. Although it's rare for someone to actually get sick from consuming raw or undercooked eggs, it's best to be careful, especially when serving egg dishes and desserts to people with compromised immune systems, the elderly, the young, and pregnant women. In these cases, be extra sure to cook eggs and egg dishes thoroughly (to 160ﾂｰF), or use pasteurized eggs. Also, be mindful of cross-contamination between raw eggs and other ingredients.");
 				}
 			}
		});
	}
